...
const char* password = "01320100Io!";

const char* mqtt_server = "srv2.clusterfly.ru"; //ip или http адрес 
int mqtt_port = 9991; //порт 
const char* mqtt_login="user_c60adb63"; //логин 
const char* mqtt_pass="pass_97d3b214"; //пароль

WiFiClient espClient;
PubSubClient client(espClient);
unsigned long lastMsg = 0;
#define MSG_BUFFER_SIZE (50) char msg[MSG_BUFFER_SIZE];
int value = 0;
