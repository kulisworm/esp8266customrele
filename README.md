...
В интернете полно гайдов ,как это сделать через Домовенка Кузю, вы должны будете создать два правила HTTP(GET) на включение и выключение, используя запросы, данные в начале статьи. Потом создаете новое устройство (рекомендую выключатель) и добавляете ему эти правила.
Готово!
